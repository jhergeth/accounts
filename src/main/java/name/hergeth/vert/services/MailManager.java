...
public class MailManager {
    ...
    public MailManager(Cfg vm, VertMailLogRep mlr){
        this.vmConfig = vm;
        this.vertMailLogRep = mlr;
    ...
    private void mLog(String time, String lText, String dieMail) {
        VertMailLog ml = new VertMailLog(true, time, lText, dieMail);
...
//        props.put("mail.smtp.ssl.enable", "true");
    ...
    public FTLManager initMailContext(String sender, String sw, String valid, String resp){
        ...
        final String tDir = vmConfig.get("mailtemplatedir", "C:/TEMP/VMAILER/MailTmpl");
    ...
    public String sendMail(FTLManager ftl, String recv, String cc, String bc, String template, File[] files) {
        ...
        try {
            ...
            eMail.setDataSourceResolver(new DataSourceFileResolver(new File(vmConfig.get("mailtemplatedir","C:/TEMP/VMAILER/MailTmpl"))));
