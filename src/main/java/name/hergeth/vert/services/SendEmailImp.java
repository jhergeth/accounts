...
public class SendEmailImp implements SendEmail {
    ...
    public SendEmailImp(Cfg vMailerConfiguration, VertRepository vertRepository){
    ...
    private void mLog(String time, String kuk, String dieMail, String rec, String s) {
        VertMailLog ml = new VertMailLog(true, time, s + kuk + " an:" + rec, dieMail);
        vertMailLogRep.save(ml);
    }
    ...
    public void prepareMails(boolean send){
        if(!send){
            ...
            vertMailLogRep.deleteBySend(false);
     ...
     */
    @Override
    public void sendReminder(boolean send, String time, String kuk, List<VertVertretung> vList, List<VertVertretung> praesList, int vAnz, List<VertVertretung> vNeu){
    ...
    @Override
    public void sendReminderToBiGaKo(boolean send, String time, String kuk, List<VertVertretung> vList, List<VertVertretung> vNeu){
    ...
    @Override
    public void sendAnwesenheiten(VertVertretung v){
//        sendMails(v, "", "mailanwesenheiten", "Anwesenheit");
    ...
    private void addVertretung(VertVertretung v) {
    ...
    public void doSendMail(String rec, String subj, String dieMail) throws EmailException {
        ...
        email.setSmtpPort(Integer.parseInt(vMailerConfiguration.get("mailsmtpport", "465")));
